...
class DatasetForm(FlaskForm):
    ...
    start_date = DateTimeField('start_date (format={})'.format(DATE_FMT), format=DATE_FMT, validators=[DataRequired()])
    end_date = DateTimeField('end_date (format="{}")'.format(DATE_FMT), format=DATE_FMT, validators=[DataRequired()])
    time_res = StringField('time_res (timesteps per day)', validators=[DataRequired()])
